...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Was added : " + (bookFounded.isPresent() ? bookFounded.get() : "No"));
        starWars.setPrice(BOOK_TEST_PRICE_NEW);
        bookDao.update(starWars);
        bookFounded = bookDao.findById(starWars.getId());
        System.out.println("Was updated : " + (bookFounded.isPresent() ? bookFounded.get() : "No"));
        System.out.println("Was deleted : " + starWars + " " + bookDao.deleteById(starWars.getId()));
