...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Book got by id is: %s", actual.toString());

        System.out.println("\n\nLet's try to change our book...");
        book.setTitle("THE NEW Principles of Programming");
        bookDao.update(book);
        actual = bookDao.findById(id);
        System.out.printf("Updated book is: %s", actual.toString());
        ...
        actual = bookDao.findById(id);
        System.out.printf("Book got by deleted id is: %s", actual.toString());
    }
}
