...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Successful created book: " + bookCreated
                + bookDao.create(new Book("The Host", BigDecimal.valueOf(129))));
        System.out.println("Find by id '2': " + bookDao.findById(2L));
        List<Book> allBooks = bookDao.findAll();
        System.out.println("All books: " + allBooks);
        System.out.println("Updated book: "
                + bookDao.update(new Book(bookCreated.getId(), "Renegades",
