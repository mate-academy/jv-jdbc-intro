...
public class Injector {
    private static final Map<String, Injector> INJECTOR = new HashMap<>();
    ...
    public static Injector getInstance(String mainPackageName) {
        if (INJECTOR.containsKey(mainPackageName)) {
            return INJECTOR.get(mainPackageName);
        }
        Injector injector = new Injector(mainPackageName);
        INJECTOR.put(mainPackageName, injector);
        return injector;
    }
