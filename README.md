...
- Establish mate.academy.connection to your Database. Be sure you have installed DB and you are able to create a new schema for this task.
...
#### DB mate.academy.connection error: 
...
Try to set timezone explicitly in your mate.academy.connection URL. <br>
Example: <br>
