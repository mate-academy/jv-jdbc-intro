...
- Create `Book` mate.academy.model.
- Create DAO  layer for `Book` mate.academy.model. Below you can see the list of required methods.
...
It should be extended from `RuntimeException`. You should rethrow this mate.academy.exception in `catch` block on mate.academy.dao layer.
